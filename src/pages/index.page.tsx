          ...
          <div className="w-full max-w-md space-y-8">
            <div>
              ...
              <p className="mt-2 text-sm text-center text-white">
                An OBS widget for twitch that automatically plays a Youtube
                video when a viewers demands it.
              </p>
            </div>
                    ...
                    <div className="-space-y-px rounded-md shadow-sm">
                      <div>
                        ...
                        <p className="mt-1 mb-2 text-sm text-white">
                          It is possible to leave this section empty. However,
                          in order to receive notifications from the bot, such
                          as{' '}
                          <em>
                            &#34;@user played https://youtu.be/videoId&#34;
                          </em>
            ...
            <AnimatePresence>
              {generatedLink && (
                ...
                >
                  ...
                  <p className="mt-2 text-sm text-center text-white">
                    Copy and paste the link above to your OBS browser source
                    with 1280 width and 720 height.
                  </p>
                </motion.div>
              )}
            </AnimatePresence>
